...
class Ui_LayersPanelDialog(object):
    def setupUi(self, LayersPanelDialog):
        ...
        LayersPanelDialog.resize(429, 419)
        self.buttonBox = QtWidgets.QDialogButtonBox(LayersPanelDialog)
        self.buttonBox.setGeometry(QtCore.QRect(100, 360, 301, 32))
        ...
        self.scrollArea.setGeometry(QtCore.QRect(20, 100, 381, 211))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 377, 207))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.selectLayersGroupBox = QtWidgets.QGroupBox(self.scrollAreaWidgetContents)
        self.selectLayersGroupBox.setGeometry(QtCore.QRect(9, 20, 351, 151))
        ...
        self.blocksLayerNameEdit.setGeometry(QtCore.QRect(150, 40, 171, 33))
        ...
        self.nodesLayerNameEdit.setGeometry(QtCore.QRect(150, 90, 171, 33))
    ...
    def retranslateUi(self, LayersPanelDialog):
        ...
        self.blocksLayerLabel.setText(_translate("LayersPanelDialog", "Capa de manzanas"))
        self.nodesLayerLabel.setText(_translate("LayersPanelDialog", "Capa de nodos"))
        self.createLayersGroupBox.setTitle(_translate("LayersPanelDialog", "Crear Capa"))
        self.blocksEditLabel.setText(_translate("LayersPanelDialog", "Capa de manzanas"))
        self.nodesEditLabel.setText(_translate("LayersPanelDialog", "Capa de nodos"))
