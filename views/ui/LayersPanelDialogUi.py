...
class Ui_LayersPanelDialog(object):
    def setupUi(self, LayersPanelDialog):
        ...
        self.importSurveysButton = QtWidgets.QPushButton(self.selectLayersGroupBox)
        self.importSurveysButton.setGeometry(QtCore.QRect(170, 130, 171, 31))
        icon = QtGui.QIcon.fromTheme("reload")
        self.importSurveysButton.setIcon(icon)
        self.importSurveysButton.setObjectName("importSurveysButton")
    ...
    def retranslateUi(self, LayersPanelDialog):
        ...
        self.importSurveysButton.setText(_translate("LayersPanelDialog", "importar encuestas"))
