...
class Ui_SurveysDialog(object):
    def setupUi(self, SurveysDialog):
        ...
        self.surveysTableWidget.setColumnCount(3)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.surveysTableWidget.setHorizontalHeaderItem(2, item)
