...
class Ui_BlockDialog(object):
    def setupUi(self, BlockDialog):
        ...
        self.surveysView = QtWidgets.QTableView(BlockDialog)
        self.surveysView.setObjectName("surveysView")
        self.gridLayout_2.addWidget(self.surveysView, 4, 0, 1, 2)
        ...
        BlockDialog.setTabOrder(self.dateEdit, self.blockEdit)
        BlockDialog.setTabOrder(self.blockEdit, self.watershed)
